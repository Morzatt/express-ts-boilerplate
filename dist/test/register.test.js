...
// Mocks setup
// GetUser Mock
const getUserMock = login_1.login.getUser = vitest_1.vi.fn();
// Insert User Mock
const insertMock = register_1.register.insertUser = vitest_1.vi.fn();
...
(0, vitest_1.describe)("CREATE USERS", () => {
    ...
    (0, vitest_1.test)("SHOULD REGISTER USER", () => __awaiter(void 0, void 0, void 0, function* () {
        getUserMock.mockImplementation((userdata) => {
            return new Promise((resolve, reject) => {
                return resolve(null);
            });
        });
